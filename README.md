...
The scraper currently uses Selenium WebDriver to drive a headless Chrome browser. To run this script you need to install Selenium
```
pip install selenium
```
as well as Chrome and ChromeDriver. The installation of the latter is platform-dependent.